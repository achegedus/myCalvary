...
@interface WhereIsCalvaryObject : KrollCoverageObject {
#else
@interface WhereIsCalvaryObject : KrollObject {
#endif
@private
...
extern NSString * WhereIsCalvary$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	WhereIsCalvaryObject *_whereiscalvary;
	BOOL shutdown;
