...
// in simulator we redefine to format for WhereIsCalvary Developer console
...
{\
	NSString * exceptionName = [@"org.whereiscalvary." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.whereiscalvary";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIWhereIsCalvaryNativeItemNone = -1, 
	UIWhereIsCalvaryNativeItemSpinner = -2,
	UIWhereIsCalvaryNativeItemProgressBar = -3,
	
	UIWhereIsCalvaryNativeItemSlider = -4,
	UIWhereIsCalvaryNativeItemSwitch = -5,
	UIWhereIsCalvaryNativeItemMultiButton = -6,
	UIWhereIsCalvaryNativeItemSegmented = -7,
	
	UIWhereIsCalvaryNativeItemTextView = -8,
	UIWhereIsCalvaryNativeItemTextField = -9,
	UIWhereIsCalvaryNativeItemSearchBar = -10,
	
	UIWhereIsCalvaryNativeItemPicker = -11,
	UIWhereIsCalvaryNativeItemDatePicker = -12,
	
	UIWhereIsCalvaryNativeItemInfoLight = -13,
	UIWhereIsCalvaryNativeItemInfoDark = -14,
	
	UIWhereIsCalvaryNativeItemDisclosure = -15,
	
	UIWhereIsCalvaryNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WhereIsCalvary instances of
