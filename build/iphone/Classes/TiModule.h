...
/**
 The base class for all WhereIsCalvary modules
 */
...
/**
 WhereIsCalvary Platform calls this method on startup.
 */
-(void)startup;

/**
 WhereIsCalvary Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 WhereIsCalvary Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 WhereIsCalvary Platform calls this method on resume.
 @param sender The sender of the event.
 */
