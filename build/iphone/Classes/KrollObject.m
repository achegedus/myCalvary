 ...
 * Copyright (c) 2009-2011 by WhereIsCalvary, Inc. All Rights Reserved.
...
//@interface WhereIsCalvaryObject : NSObject
//@end

@interface WhereIsCalvaryObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WhereIsCalvaryObject class]])
		{
			for (NSString *key in [[(WhereIsCalvaryObject*)o modules] allKeys])
			{
