...
//Rare exceptions to indicate a bug in the _whereiscalvary code (Eg, function that a subclass should have implemented)
...
/**
 The base class for WhereIsCalvary proxies.
 */
